...
export default function Login() {
  ...
  const [mapLocker, setMapLocker] = useState([
    ...
    { key: '2', type: false, data: LockerContainerY, pressFunc: () => {gColor = '#FDFF97'; navigation.navigate('Home')}},
    { key: '3', type: true, data: 'Sala 11'},
    { key: '4', type: false, data: LockerContainerY, pressFunc: () => {gColor = '#FDFF97'; navigation.navigate('Home')}},
    { key: '5', type: true, data: 'Sala 12'},
    { key: '6', type: 'line'},
    { key: '7', type: true, data: 'Saúde'},
    { key: '8', type: false, data: LockerContainerR, pressFunc: () => {gColor = '#FF7B7B'; navigation.navigate('Home')}},
    { key: '9', type: true, data: 'Sala 13'},
    { key: '10', type: false, data: LockerContainerR, pressFunc: () => {gColor = '#FF7B7B'; navigation.navigate('Home')}},
    { key: '11', type: true, data: 'Sala 14'},
    { key: '12', type: false, data: LockerContainerR, pressFunc: () => {gColor = '#FF7B7B'; navigation.navigate('Home')}},
    { key: '13', type: true, data: 'Sala 15'},
    { key: '14', type: 'line'},
    { key: '15', type: true, data: 'Sala 2'},
    { key: '16', type: false, data: LockerContainerG, pressFunc: () => {gColor = '#A6FFEA'; navigation.navigate('Home')}},
    { key: '17', type: true, data: 'Sala 3'},
    { key: '18', type: 'line'},
    { key: '19', type: true, data: 'Vestiário Masculino'},
    { key: '20', type: false, data: LockerContainerB, pressFunc: () => {gColor = '#92B7FF'; navigation.navigate('Home')}},
    { key: '21', type: true, data: 'Sala 4'},
    { key: '22', type: false, data: LockerContainerB, pressFunc: () => {gColor = '#92B7FF'; navigation.navigate('Home')}},
